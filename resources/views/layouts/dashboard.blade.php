...
<body class="bg-[#050505] text-white overflow-hidden" x-data="{ sidebarOpen: window.innerWidth >= 768, mobileMenuOpen: false }">
    <div class="flex h-screen">
        ...
        <!-- Sidebar -->
        <aside class="fixed md:static inset-y-0 left-0 z-50 flex flex-col h-full border-r border-[#23242A] bg-[#0A0A0A] transition-all duration-300 ease-in-out md:flex"
               :class="[
                   sidebarOpen ? 'md:w-[280px]' : 'md:w-[88px]',
            ...
            <nav class="flex-1 px-4 space-y-8 overflow-y-auto py-4 custom-scrollbar">
                <div class="space-y-1">
                    <p class="px-4 text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3 whitespace-nowrap overflow-hidden transition-all duration-300" 
                       x-show="sidebarOpen || mobileMenuOpen" x-transition>Overview</p>
                    <div x-show="!sidebarOpen && !mobileMenuOpen" class="h-px w-8 bg-[#23242A] mx-auto mb-3 hidden md:block"></div>

                    <a href="{{ route('dashboard.index') }}" class="nav-item group" :class="!sidebarOpen && !mobileMenuOpen ? 'justify-center px-2' : ''">
                        ...
                        <span x-show="sidebarOpen || mobileMenuOpen" x-transition.opacity.duration.200ms class="truncate">Dashboard</span>
                    </a>
                </div>

                <div class="space-y-1">
                    <p class="px-4 text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3 whitespace-nowrap overflow-hidden transition-all duration-300"
                       x-show="sidebarOpen || mobileMenuOpen" x-transition>Content</p>
                    <div x-show="!sidebarOpen && !mobileMenuOpen" class="h-px w-8 bg-[#23242A] mx-auto mb-3 hidden md:block"></div>

                    <a href="{{ route('dashboard.blog') }}" class="nav-item group" :class="!sidebarOpen && !mobileMenuOpen ? 'justify-center px-2' : ''">
                        <svg class="w-5 h-5 opacity-70 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/></svg>
                        <span x-show="sidebarOpen || mobileMenuOpen" x-transition.opacity.duration.200ms class="truncate">Blog Posts</span>
                    </a>
                    <a href="{{ route('dashboard.projects') }}" class="nav-item group" :class="!sidebarOpen && !mobileMenuOpen ? 'justify-center px-2' : ''">
                        <svg class="w-5 h-5 opacity-70 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"/></svg>
                        <span x-show="sidebarOpen || mobileMenuOpen" x-transition.opacity.duration.200ms class="truncate">Projects</span>
                    </a>
                    <a href="{{ route('dashboard.skills') }}" class="nav-item group" :class="!sidebarOpen && !mobileMenuOpen ? 'justify-center px-2' : ''">
                        <svg class="w-5 h-5 opacity-70 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/></svg>
                        <span x-show="sidebarOpen || mobileMenuOpen" x-transition.opacity.duration.200ms class="truncate">Skills</span>
                    </a>
                    <a href="{{ route('dashboard.timeline') }}" class="nav-item group" :class="!sidebarOpen && !mobileMenuOpen ? 'justify-center px-2' : ''">
                        ...
                        <span x-show="sidebarOpen || mobileMenuOpen" x-transition.opacity.duration.200ms class="truncate">Timeline</span>
                    </a>
                </div>

                <div class="space-y-1">
                    <p class="px-4 text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3 whitespace-nowrap overflow-hidden transition-all duration-300"
                       x-show="sidebarOpen || mobileMenuOpen" x-transition>Management</p>
                    <div x-show="!sidebarOpen && !mobileMenuOpen" class="h-px w-8 bg-[#23242A] mx-auto mb-3 hidden md:block"></div>

                    <a href="{{ route('dashboard.tasks') }}" class="nav-item group" :class="!sidebarOpen && !mobileMenuOpen ? 'justify-center px-2' : ''">
                        ...
                        <span x-show="sidebarOpen || mobileMenuOpen" x-transition.opacity.duration.200ms class="truncate">Task Board</span>
                    </a>
                    <a href="{{ route('dashboard.focus') }}" class="nav-item group" :class="!sidebarOpen && !mobileMenuOpen ? 'justify-center px-2' : ''">
                        ...
                        <span x-show="sidebarOpen || mobileMenuOpen" x-transition.opacity.duration.200ms class="truncate">Focus Timer</span>
                    </a>
                    <a href="{{ route('dashboard.accountability') }}" class="nav-item group" :class="!sidebarOpen && !mobileMenuOpen ? 'justify-center px-2' : ''">
                        <svg class="w-5 h-5 opacity-70 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                        <span x-show="sidebarOpen || mobileMenuOpen" x-transition.opacity.duration.200ms class="truncate">Project Planner</span>
                    </a>
                    <a href="{{ route('dashboard.messages') }}" class="nav-item group" :class="!sidebarOpen && !mobileMenuOpen ? 'justify-center px-2' : ''">
                        ...
                        <span x-show="sidebarOpen || mobileMenuOpen" x-transition.opacity.duration.200ms class="truncate">Messages</span>
                    </a>
                    <a href="{{ route('dashboard.contact-messages') }}" class="nav-item group" :class="!sidebarOpen && !mobileMenuOpen ? 'justify-center px-2' : ''">
                        ...
                        <span x-show="sidebarOpen || mobileMenuOpen" x-transition.opacity.duration.200ms class="truncate">Contact Form</span>
                    </a>
                    <a href="{{ route('dashboard.settings') }}" class="nav-item group" :class="!sidebarOpen && !mobileMenuOpen ? 'justify-center px-2' : ''">
                        ...
                        <span x-show="sidebarOpen || mobileMenuOpen" x-transition.opacity.duration.200ms class="truncate">Settings</span>
                    </a>
                    <a href="{{ route('dashboard.ip-blacklist') }}" class="nav-item group" :class="!sidebarOpen && !mobileMenuOpen ? 'justify-center px-2' : ''">
                        ...
                        <span x-show="sidebarOpen || mobileMenuOpen" x-transition.opacity.duration.200ms class="truncate">IP Blacklist</span>
                    </a>
                </div>
            </nav>
            ...
            <div class="p-6 border-t border-[#23242A]">
                <div class="flex items-center gap-3" :class="!sidebarOpen && !mobileMenuOpen ? 'justify-center' : ''">
                    ...
                    <div class="flex-1 min-w-0" x-show="sidebarOpen || mobileMenuOpen" x-transition.opacity.duration.200ms>
                        <p class="text-sm font-semibold truncate">{{ auth()->user()->name }}</p>
                        <p class="text-[10px] text-gray-400">Pro Member</p>
                    </div>
                    <form method="POST" action="{{ route('logout') }}" x-show="sidebarOpen || mobileMenuOpen">
                        @csrf
        ...
        <main class="flex-1 overflow-hidden flex flex-col relative bg-[#050505] w-full">
            ...
            <header class="h-20 md:h-24 px-4 md:px-8 flex items-center justify-between z-30 transition-all duration-300">
                <div class="flex items-center gap-4 flex-1">
                     <!-- Toggle Button -->
                    <button @click="if(window.innerWidth < 768) { mobileMenuOpen = !mobileMenuOpen } else { sidebarOpen = !sidebarOpen }" 
                            class="text-gray-500 hover:text-white transition-colors p-2 rounded-lg hover:bg-[#1A1B21]">
