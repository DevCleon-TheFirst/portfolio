            ...
            <div class="premium-card p-6 group hover:border-indigo-500/30 transition-colors">
                <div class="flex justify-between items-start mb-4">
                    <div>
                        ...
                        <div class="px-2 py-1 rounded bg-[#1A1B21] border border-[#23242A] text-xs text-gray-400 inline-block mt-1">
                            {{ $project->status }}
                        </div>
                    </div>
                    
                    <button wire:click="deleteProject({{ $project->id }})" 
                            wire:confirm="Are you sure you want to delete this project? All associated tasks will be deleted too."
