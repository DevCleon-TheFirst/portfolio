                    ...
                    <div class="pt-4 border-t border-[#23242A] flex justify-between items-center mt-auto">
                        ...
                        <div class="flex gap-2">
                             @if($project->project_url)
                                <a href="{{ $project->project_url }}" target="_blank" class="p-2 text-gray-400 hover:text-indigo-400 hover:bg-[#1A1B21] rounded-lg transition-colors" title="View Live Site">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
                                </a>
                             @endif
                             <button wire:click="edit({{ $project->id }})" class="p-2 text-gray-400 hover:text-white hover:bg-[#1A1B21] rounded-lg transition-colors" title="Edit Project">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/></svg>
                            </button>
                            <button wire:click="delete({{ $project->id }})" class="p-2 text-gray-400 hover:text-red-400 hover:bg-[#1A1B21] rounded-lg transition-colors" title="Delete Project">
